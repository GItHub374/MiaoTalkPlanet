...
@ccclass('notice_dialog')
export class notice_dialog extends UIPopupComponent {
    ...
    private init_button(){
        ...
        let text1 = this.btn_confirm.getChildByName("text")?.getComponent(Label)!
        text1.string = this.build_args.confirm_text || "Confirm"

        let text2 = this.btn_cancel.getChildByName("text")?.getComponent(Label)!
